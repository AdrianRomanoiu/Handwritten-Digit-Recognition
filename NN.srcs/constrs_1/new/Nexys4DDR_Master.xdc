...
create_clock -add -name sys_clk_pin -period 50.00 -waveform {0 5} [get_ports {CLK50}];
...
set_property -dict { PACKAGE_PIN K15   IOSTANDARD LVCMOS33 } [get_ports { BUSY }]; #IO_L24P_T3_RS1_15 Sch=led[1]
...
#set_property -dict { PACKAGE_PIN G14   IOSTANDARD LVCMOS33 } [get_ports { LED17_B }]; #IO_L1F5N_T2_DQS_ADV_B_15 Sch=led17_b
